    ...
    <body>
        <div class="container">
            ...
            <form action="/submit" method="POST" enctype="multipart/form-data">
                ...
                <label for="resume_post_id">Resume Post ID (Optional):</label>
                <input type="text" id="resume_post_id" name="resume_post_id">

                <label for="hater_name">Hater Name (Optional):</label>
...
def submit():
    ...
    for comment in comments:
        # Replace {hater} with the provided hater name
        if hater_name:
            comment = comment.replace("{hater}", hater_name)
